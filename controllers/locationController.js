...
module.exports = {
    getListLocation: (req,res) => {
        var sql = 'SELECT * FROM location ORDER BY id DESC;';
    ...
    getLocation: (req,res) => {
        if(req.body.city) {
            var sql = `SELECT * FROM location WHERE city = '${req.body.city}' ORDER BY id DESC`;
            conn.query(sql, (err, results) => {
                if(err) throw err;
                res.send(results);
            });
        } else {
            var sql = `SELECT * FROM location WHERE id = '${req.body.id}' ORDER BY id DESC`;
            conn.query(sql, (err, results) => {
                if(err) throw err;
                res.send(results);
            });
